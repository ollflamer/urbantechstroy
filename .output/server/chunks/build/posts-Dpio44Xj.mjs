...
const usePostsStore = defineStore("posts", () => {
  ...
  const addPost = (post) => {
    var _a, _b;
    const createdAt = (_a = post.createdAt) != null ? _a : (/* @__PURE__ */ new Date()).toISOString();
    posts.value.unshift({
      title: post.title,
      content: post.content,
      image: (_b = post.image) != null ? _b : null,
      createdAt
    });
  };
  ...
  const getPostBySlug = (slug) => {
    ...
    return (_a = posts.value.find((p) => slugify(p.title) === slug)) != null ? _a : null;
  };
  return {
    posts,
    getPosts,
...
export { useSlugify as a, usePostsStore as u };
//# sourceMappingURL=posts-Dpio44Xj.mjs.map
