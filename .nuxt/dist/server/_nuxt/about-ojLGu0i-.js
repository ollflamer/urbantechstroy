const aboutIntro = {
  ...
  description: "Наши строительные бригады — это команды профессионалов с многолетним опытом, проверенные временем. Мы гарантируем высокое качество работ, соблюдение сроков и индивидуальный подход к каждому проекту."
};
const aboutStats = [
  {
    value: "28",
...
const homeAboutFeatures = [
  {
    ...
    description: "Руководитель компании имеет богатый опыт управления строительными проектами"
  },
  {
    icon: "/icons/about-stat-specialists.svg",
    title: "Международный опыт",
    description: "Реализация проектов как в Узбекистане, так и на международном уровне"
  },
  {
    icon: "/icons/about-stat-projects.svg",
...
export {
  ...
  aboutPortfolio as c,
  aboutDirector as d,
  aboutPaymentMethods as e,
  homeAboutFeatures as h
};
//# sourceMappingURL=about-ojLGu0i-.js.map
