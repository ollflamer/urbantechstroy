...
export const services: Service[] = [
	{
		...
		stages: [
			...
			{ step: 4, title: 'Строительство стен и перекрытий' },
			{
				step: 5,
				title:
					'Монтаж инженерных систем (электричество, водоснабжение, отопление)',
			},
	...
	},
	{
		...
		shortDescription:
			'Индивидуальное проектирование и строительство частных домов и коттеджей любой сложности',
	...
	},
	{
		...
		shortDescription:
			'Проектирование и возведение общежитий с учетом всех норм и требований безопасности',
	...
	},
	{
		...
		shortDescription:
			'Полная реконструкция и капитальный ремонт зданий любого назначения с восстановлением конструкций',
	...
	},
	{
		...
		shortDescription:
			'Устройство фундаментов, стяжек, монолитных конструкций с использованием качественного бетона',
	...
	},
	{
		...
		shortDescription:
			'Кирпичная кладка стен, перегородок и других конструкций с соблюдением технологии',
	...
	},
	{
		...
		shortDescription:
			'Ландшафтное проектирование, озеленение, устройство дорожек и благоустройство прилегающих территорий',
	...
	},
	{
		...
		shortDescription:
			'Утепление и отделка фасадов современными материалами, навесные вентилируемые фасады',
	...
	},
	{
		...
		shortDescription:
			'Изготовление и монтаж металлических каркасов для зданий, ангаров и промышленных объектов',
	...
	},
	{
		...
		shortDescription:
			'Комплексная внутренняя отделка помещений: штукатурка, шпаклевка, покраска, поклейка обоев',
	...
	},
	{
		...
		shortDescription:
			'Качественная наружная отделка зданий с применением современных технологий и материалов',
	...
	},
	{
		...
		shortDescription:
			'Устройство и ремонт кровли любой сложности, монтаж водосточных систем',
